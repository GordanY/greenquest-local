...
//#endregion
//#region src/index.ts
const admin_activate_key = table({ public: false }, {
	key: t.string().primaryKey(),
	active: t.bool().default(true)
});
const user = table({ public: false }, {
	id: t.identity().primaryKey(),
	name: t.string(),
	role: t.string().default("user")
});
const user_profile = table({ public: false }, {
	user_id: t.identity().primaryKey(),
	experience_points: t.number().default(0),
	seeds: t.number().default(100),
	pet_type: t.string(),
	pet_stage: t.number().default(1),
	pet_name: t.string().default("小種籽")
});
const spacetimedb = schema({
	user,
	admin_activate_key,
	user_profile,
	plant_types: table({ public: true }, {
	...
	upload_records: table({ public: true }, {
		user_id: t.identity(),
		mimeType: t.string(),
	...
	class_sessions: table({ public: true }, {
		access_code: t.string().index("btree"),
		creator_id: t.identity(),
		start_time: t.number(),
		end_time: t.number()
	}),
	class_sessions_uploads: table({ public: true }, {
...
const init = spacetimedb.init((ctx) => {
	...
	ctx.db.plant_types.insert({
		...
		hints: "你找到了非維管植物！它們是最古老的陸生植物之一，在約4億7千萬年前率先登上陸地。苔蘚沒有根，靠整個葉狀體吸收水分，因此特別依賴潮濕環境——它們也是濕地生態系的重要指示物種。",
		extras: "非維管植物的出現是植物演化史上的重大突破！維管束系統（木質部和韌皮部）讓植物得以長高，形成今日的森林。地球上超過90%的植物種類都是維管植物。",
		icons: "🌿"
	});
	ctx.db.plant_types.insert({
		name: "維管植物",
		description: "維管植物擁有運輸水分和養分的維管束。蕨類、開花植物和松樹都屬於維管植物，但苔蘚不算。試試找一種有葉有莖的植物。",
		hints: "維管植物的出現是植物演化史上的重大突破！維管束系統（木質部和韌皮部）讓植物得以長高，形成今日的森林。地球上超過90%的植物種類都是維管植物。",
		extras: "非維管植物的出現是植物演化史上的重大突破！維管束系統（木質部和韌皮部）讓植物得以長高，形成今日的森林。地球上超過90%的植物種類都是維管植物。",
		icons: "🌱"
	});
	ctx.db.plant_types.insert({
		...
		hints: "蕨類植物在3億多年前的石炭紀曾是地球的主宰！那時的蕨類可高達30公尺，形成龐大的「蕨類森林」。今天我們燃燒的煤炭，大部分正是由那個時代的蕨類化石形成的。",
...
const activate_admin = spacetimedb.reducer({ key: t.string() }, (ctx, { key }) => {
	...
	if (record && record.active) {
		...
		if (user) {
			...
			return;
		} else throw new SenderError("User not found");
	} else throw new SenderError("Invalid activation key");
});
const create_class_session = spacetimedb.reducer({
	access_code: t.string(),
	duration_minutes: t.number()
}, (ctx, { access_code, duration_minutes }) => {
	const user = ctx.db.user.id.find(ctx.sender);
	if (user && user.role === "admin") {
		ctx.db.class_sessions.insert({
			...
			start_time: Date.now(),
			end_time: Date.now() + duration_minutes * 60 * 1e3
		});
		return;
	} else throw new SenderError("Unauthorized error: create class session");
});
const create_new_user = spacetimedb.reducer({
	name: t.string(),
	pet_type: t.string(),
	pet_name: t.string()
}, (ctx, { name, pet_type, pet_name }) => {
	if (ctx.db.user.id.find(ctx.sender)) throw new SenderError("User already exists");
...
const get_user_profile = spacetimedb.view({
	name: "my_profile",
	public: true
}, t.option(user_profile.rowType), (ctx) => {
	const user_profile = ctx.db.user_profile.user_id.find(ctx.sender);
	if (!user_profile) throw new SenderError("User profile not found");
	return user_profile;
});
const upload_plant_photo = spacetimedb.reducer({
	mimeType: t.string(),
	photo_blob: t.array(t.u8()),
	plant_name: t.string(),
	plant_type: t.string()
}, (ctx, { mimeType, photo_blob, plant_name, plant_type }) => {
	if (!ctx.db.user.id.find(ctx.sender)) throw new SenderError("User not found");
...
//#endregion
export { activate_admin, create_class_session, create_new_user, spacetimedb as default, get_user_profile, init, onConnect, onDisconnect, upload_plant_photo };
//# debugId=d132f365-e82d-4e4e-9f73-7bf1c5efedb7
//# sourceMappingURL=data:application/json;charset=utf-8;base64,