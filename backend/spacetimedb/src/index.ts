...
export const init = spacetimedb.init(ctx => {
  ...
  ctx.db.plant_types.insert({
    name: '非維管植物',
    description: '找一種沒有維管束的植物，例如苔蘚、地衣或藻類。',
    extras: '你找到了非維管植物！它們是最古老的陸生植物之一，在約4億7千萬年前率先登上陸地。苔蘚沒有根，靠整個葉狀體吸收水分，因此特別依賴潮濕環境——它們也是濕地生態系的重要指示物種。',
    hints: '非維管植物沒有導水的維管束組織。試試找找苔蘚（Mosses）、地錢（Liverworts）或藻類（Algae）——它們通常生長在潮濕的石頭、樹幹或水中。',
    icons: '🌿'
  });
  ctx.db.plant_types.insert({
    name: '維管植物',
    description: '找任何有根、莖、葉的植物，例如蕨類、松樹或開花植物。',
    extras: '維管植物的出現是植物演化史上的重大突破！維管束系統（木質部和韌皮部）讓植物得以長高，形成今日的森林。地球上超過90%的植物種類都是維管植物。',
    hints: '維管植物擁有運輸水分和養分的維管束。蕨類、開花植物和松樹都屬於維管植物，但苔蘚不算。試試找一種有葉有莖的植物。',
    icons: '🌱'
  });
  ctx.db.plant_types.insert({
    name: '無種子植物',
    description: '找一種靠孢子繁殖的植物，蕨類是最常見的例子。',
    extras: '蕨類植物在3億多年前的石炭紀曾是地球的主宰！那時的蕨類可高達30公尺，形成龐大的「蕨類森林」。今天我們燃燒的煤炭，大部分正是由那個時代的蕨類化石形成的。',
    hints: '無種子植物靠孢子繁殖，而非種子。蕨類（Ferns）就是最好的例子——注意葉背面的孢子囊，或在林蔭濕地尋找蕨類植物。',
    icons: '🍃'
  });
  ctx.db.plant_types.insert({
    name: '種子植物',
    description: '找一種用種子繁殖的植物——開花植物或毬果植物都算。',
    extras: '種子是植物的偉大發明——它為胚胎提供養分和保護，讓植物得以在乾燥環境中繁殖。正因如此，種子植物在大約3億年前開始主導陸地生態系，並演化出我們今日看到的繁茂多樣。',
    hints: '種子植物用種子繁殖。開花植物和松樹、杉樹都是種子植物。試試找一棵結果或有毬果的樹木，或任何開花的植物。',
    icons: '🌰'
  });
  ctx.db.plant_types.insert({
    name: '無花植物',
    description: '找一種用毬果繁殖的植物，例如松樹、杉樹、銀杏或蘇鐵。',
    extras: '裸子植物的種子是「裸露」的，意思是沒有果實包裹。銀杏（Ginkgo biloba）是裸子植物中最古老的「活化石」，其祖先可追溯至2億7千萬年前，恐龍曾在銀杏樹下乘涼！香港的郊野公園中就有松樹和羅漢松等裸子植物。',
    hints: '無花植物（裸子植物）用毬果而非花朵繁殖。試試找松樹（Pine）、杉樹（Cypress）、銀杏（Ginkgo）或蘇鐵（Cycad）——它們的種子是「裸露」的，沒有果實包裹。',
    icons: '🌲'
  });
  ctx.db.plant_types.insert({
    name: '有花植物',
    description: '找任何一種會開花的植物——路邊的野花或花圃的植物都可以。',
    extras: '被子植物是地球上最成功的植物類群，擁有超過30萬個已知種。它們與蜜蜂、蝴蝶等傳粉者共同演化，形成了地球生態系最重要的夥伴關係之一。從稻米、小麥到蘋果，人類的主食幾乎全來自被子植物。',
    hints: '有花植物（被子植物）是最多樣的植物類群。無論是玫瑰、蘭花、向日葵還是禾草，只要會開花就算。試試在花圃或路邊找任何一種開花的植物。',
    icons: '🌸'
  });
  ctx.db.plant_types.insert({
    name: '裸子植物',
    description: '找一種種子裸露、用毬果繁殖的植物，如松樹、杉樹、銀杏。',
    extras: '裸子植物在距今約3億年前出現，是最早的種子植物。它們曾在恐龍時代主宰地球。銀杏是「活化石」，其形態在2億多年間幾乎沒有改變！',
    hints: '裸子植物的種子裸露在外，沒有果實包裹。松樹（Pine）、杉樹（Cypress）、銀杏（Ginkgo）和蘇鐵（Cycad）都是裸子植物——尋找有毬果的樹木。',
    icons: '🌲'
  });
  ctx.db.plant_types.insert({
    name: '蕨類植物',
    description: '找一種靠孢子繁殖的蕨類，注意羽狀複葉和葉背孢子囊。',
    extras: '蕨類植物在石炭紀（約3.5億年前）稱霸地球，巨大的樹蕨高達30公尺。今天的煤炭大多由那時的蕨類森林形成。全球現存約1萬種蕨類。',
    hints: '蕨類植物沒有種子，靠孢子繁殖。注意它們特徵性的羽狀複葉，翻過來看葉背可能有棕色孢子囊群。在潮濕陰暗的林下或溪邊最容易找到。',
    icons: '☘️'
  });
  ctx.db.plant_types.insert({
    name: '單子葉植物',
    description: '找一種平行脈葉片的植物，如禾草、百合、棕櫚或竹子。',
    extras: '單子葉植物包含人類最重要的糧食作物：稻米、小麥、玉米。禾本科（草）覆蓋了地球陸地面積的約20%，是最成功的植物家族之一。',
    hints: '單子葉植物的特徵是平行脈葉片、花瓣多為3的倍數。禾草、竹子、百合、蘭花、棕櫚、香蕉都是單子葉植物。',
    icons: '🌾'
  });
  ctx.db.plant_types.insert({
    name: '雙子葉植物',
    description: '找一種網狀脈葉片的開花植物，如玫瑰、向日葵或榕樹。',
    extras: '雙子葉植物是被子植物中種類最多的一群，約佔開花植物的75%。從微小的野花到巨大的闊葉樹，雙子葉植物的多樣性令人驚嘆。',
    hints: '雙子葉植物葉片通常有網狀脈，花瓣多為4或5的倍數。玫瑰、向日葵、豆科植物、大部分的樹木（楓、榕、木棉）都是雙子葉植物。',
    icons: '🌻'
  });
});
